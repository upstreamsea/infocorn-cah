...
cah.$.GamePlayerStatus_msg['sj'] = "Card Daddy";
...
cah.$.GamePlayerStatus_msg_2['sj'] = "You are the Card Daddy.";
...
cah.$.ErrorCode_msg = {};
cah.$.ErrorCode_msg['cii'] = "Invalid CRCast ID. Must be exactly 5 characters.";
...
cah.$.ErrorCode_msg['ccf'] = "Cannot find CRCast deck with given ID. If you just added this deck to CRCast, wait a few minutes and try again.";
